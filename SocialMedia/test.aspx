<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test.aspx.cs" Inherits="SocialMedia.test" %>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <div class="mt-3">
                                    <button id="btn_submit" runat="server" class="btn btn-primary me-2">Submit</button>
                                    <asp:Button ID="btn_update" runat="server" class="btn btn-danger" Text="Update" />
                                </div>
                            </div>
