<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="SocialMedia.Login" %>
                                ...
                                <div class="sign-in-from">
                                    ...
                                    <form class="mt-4">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control mb-0" id="txt_email" runat="server" required="required" placeholder="Enter email">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label" for="exampleInputPassword1">Password</label>
                                            <a href="pages-recoverpw.html" class="float-end">Forgot password?</a>
                                            <input type="password" class="form-control mb-0" id="txt_pass" runat="server"  required="required" placeholder="Password">
                                        </div>
                                        <div class="d-inline-block w-100">
                                            <div class="form-check d-inline-block mt-2 pt-1">
                                                <input type="checkbox" class="form-check-input" id="customCheck11" runat="server" required="required">
                                                <label class="form-check-label" for="customCheck11">Remember Me</label>
                                            </div>
                                            <asp:Button  ID="btn_sihnin" runat="server" class="btn btn-primary float-end" Text="Sign in" OnClick="btn_sihnin_Click"   />
                                        </div>
                                        <div class="sign-info">
                                            <span class="dark-color d-inline-block line-height-2">Don't have an account? <a href="Register.aspx">Sign up</a></span>
